...
FX = 529.0  # your calibrated focal length in pixels

# Robot behavior thresholds
DANGER_AREA_RATIO = 0.08       # object fills 8% of frame = probably close
...
TARGET_CLASSES = None
# Example if you want to restrict:
# TARGET_CLASSES = {"person", "chair", "backpack", "bottle", "cup", "laptop"}
